...
private fun TreeGenerator.printIrSymbolTree(generationPath: File, model: Model<Element>) {
    ...
    generatedFiles += printSymbolRemapper(generationPath, model, declaredSymbolRemapperType, ::DeclaredSymbolRemapperInterfacePrinter)
    generatedFiles += printSymbolRemapper(generationPath, model, referencedSymbolRemapperType, ::ReferencedSymbolRemapperInterfacePrinter)
    generatedFiles += printSymbolRemapper(generationPath, model, symbolRemapperType, ::SymbolRemapperInterfacePrinter)
}
